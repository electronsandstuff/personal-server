...
domains=(grafana.chris-pierce.com)
rsa_key_size=4096
...
echo "### Starting nginx ..."
docker compose -f docker-compose.yaml up --force-recreate -d db
docker compose -f docker-compose.yaml up --force-recreate -d web
